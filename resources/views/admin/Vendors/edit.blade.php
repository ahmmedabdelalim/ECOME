                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.vendors.update',$vendors -> id)}}"
                                              method="POST"
                                            ...
                                            <input type="hidden"  value="{{$vendors -> latitude}}" id="latitude" name="latitude">
                                            <input type="hidden" value="{{$vendors -> longitude}}" id="longitude"  name="longitude">
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB_zSoUhEQdAqN3TW63oaXgrSaDTHmY1a4&libraries=places&callback=initAutocomplete&language=ar&region=EG
     async defer"></script>
@stop
