                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="" id="name"
                                                               ...
                                                               name="categorie[{{$index}}][name]">
                                                               @error("categorie.$index.name")
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mt-1">
                                                        <input type="checkbox"  value="1"  name="categorie[{{$index}}][active]"
                                                               id="switcheryColor4"
